{
  ...
  inputs = {
    ...
    # Pinned because of https://github.com/cachix/devenv/issues/711
    # Unpin when issue is resolved
    devenv.url = "github:cachix/devenv/eaa7d3d154e2dd58b5d275bc2f2b9a41af6fdd3d";
  };
